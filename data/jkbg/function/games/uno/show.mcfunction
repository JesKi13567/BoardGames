...
execute store result entity @e[limit=1,type=item_display,tag=jk_uno_card] item.components.minecraft:custom_model_data int 1 run scoreboard players get #uno.id jkbg.int
