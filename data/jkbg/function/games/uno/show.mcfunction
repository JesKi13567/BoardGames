...
# 弃牌堆加入
execute if score #uno.rule.samsara jkbg.int matches 1 if score #uno.id.num jkbg.int matches 13..14 run scoreboard players set #uno.samsara.color jkbg.int 5
execute if score #uno.rule.samsara jkbg.int matches 1 unless score #uno.id.num jkbg.int matches 13..14 run scoreboard players operation #uno.samsara.color jkbg.int = #uno.id.color jkbg.int
execute if score #uno.rule.samsara jkbg.int matches 1 run scoreboard players operation #uno.samsara.color jkbg.int *= #100 jkbg.int
execute if score #uno.rule.samsara jkbg.int matches 1 store result storage jkbg:uno cards.temp.mem int 1 run scoreboard players operation #uno.samsara.color jkbg.int += #uno.id.num jkbg.int
execute if score #uno.rule.samsara jkbg.int matches 1 run data modify storage jkbg:uno cards.dropped append from storage jkbg:uno cards.temp.mem
