...
execute if score #uno.cards.add jkbg.int matches 1.. if score #uno.id.num jkbg.int matches 12 run tellraw @s ["", {"text": "【JKの桌游】", "color": "green"}, {"text": "你必须打出 +2 或 +4 牌！", "color": "red"}]
