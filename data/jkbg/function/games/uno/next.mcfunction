...
execute if score #uno.reverse jkbg.int matches 1 if score #uno.order jkbg.int matches ..0 run scoreboard players operation #uno.order jkbg.int = #uno.players jkbg.int
